...
class UpdateCheck(QDialog, Logger):
    url = "https://github.com/ShorelineCrypto/electrum-chta/releases/download/v4.0.0.0/version"
    download_url = "https://github.com/ShorelineCrypto/electrum-chta/releases"
